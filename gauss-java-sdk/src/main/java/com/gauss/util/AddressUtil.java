package com.gauss.util;

import com.gauss.crypto.encode.ConvertBits;
import com.gauss.crypto.hash.Ripemd;
import com.gauss.exception.AddressFormatException;
...
public class AddressUtil {
    ...
    public static String createNewAddressSecp256k1(String mainPrefix, byte[] publickKey) throws Exception {
        ...
        try {
            ...
            addressResult = com.gauss.crypto.encode.Bech32.encode(mainPrefix, bytes);
        } catch (Exception e) {
